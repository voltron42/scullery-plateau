...
(defn start-playing-zelda []
  (play-song (edn/read-string (slurp "resources/sheet/zelda.edn")) 32 2000))

(defn start-playing-scales []
  (play-song (edn/read-string (slurp "resources/sheet/scales.edn")) 32 2000))
